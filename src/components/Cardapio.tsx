...
type TabId = "doces" | "bolos" | "salgados" | "tortas" | "especiais";
...
export const Cardapio = () => {
  const [activeTab, setActiveTab] = useState<TabId>("doces");

  const tabs: Tab[] = [
    { id: "doces", name: "Doces", emoji: "🍬", color: "pink" },
    { id: "bolos", name: "Bolos", emoji: "🎂", color: "orange" },
    { id: "salgados", name: "Salgados", emoji: "🥟", color: "yellow" },
    { id: "tortas", name: "Tortas", emoji: "🥧", color: "purple" },
    { id: "especiais", name: "Especiais", emoji: "✨", color: "green" },
  ];
  ...
  const menuItems: MenuItems = {
    doces: [
      {
        ...
        price: "R$ 3,50",
        image:
          "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        popular: true,
        rating: 4.9,
        time: "30 min",
      },
      ...
      },
      {
        ...
        price: "R$ 4,50",
        image:
          "https://images.unsplash.com/photo-1576618148400-f54bed99fcfd?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        rating: 4.9,
        time: "40 min",
      },
    ],
    bolos: [
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        rating: 5.0,
        time: "24h",
      },
    ],
    salgados: [
      {
        ...
        price: "R$ 4,50",
        image:
          "https://images.unsplash.com/photo-1625869016774-3d0e066de32a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        popular: true,
        rating: 4.8,
        time: "15 min",
      },
      {
        ...
        price: "R$ 3,75",
        image:
          "https://images.unsplash.com/photo-1612874742237-6526221588e3?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        rating: 4.6,
        time: "20 min",
      },
      {
        ...
        price: "R$ 5,00",
        image:
          "https://images.unsplash.com/photo-1601314002957-022d734e4d9d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        rating: 4.7,
        time: "25 min",
      },
      {
    ...
    tortas: [
      ...
      },
      {
        ...
        price: "R$ 58,00",
        image:
          "https://images.unsplash.com/photo-1549395156-e0c1fe6fc7d0?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        rating: 4.7,
        time: "2h",
      },
      {
        ...
        price: "R$ 62,00",
        image:
          "https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        rating: 4.8,
        time: "1h 50min",
      },
    ],
